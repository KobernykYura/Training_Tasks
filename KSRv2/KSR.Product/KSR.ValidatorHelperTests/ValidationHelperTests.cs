...
namespace KSR.ValidatorHelper.Tests
{
    ...
    public class ValidationHelperTests
    {
        ...
        {
            var obj = new BulkProduct();
            string message = "Problem";

            ValidationHelper.ObjectNotType<AbstractProduct>(obj, message);
        }

        [TestMethod()]
        public void ObjectNotTypeTest_LiquidProductIsAbstractProduct()
        {
            var obj = new LiquidProduct();
            string message = "Problem";
        ...
        {
            var obj = new BulkProduct("Chalk", 1, 1);
        ...
        {
            var obj = new BulkProduct("Chalk", -891, 1);
