...
namespace KSR.ValidatorHelper
{
    ...
    {
        /// <summary>
        /// The method throws an <see cref="ArgumentNullException"/> if the object is null.
        /// </summary>
        ...
        /// <summary>
        /// The method throws an <see cref="ArgumentNullException"/> if the object is not null.
        /// </summary>
        /// <param name="obj">inspected object.</param>
        /// <param name="message">exception message.</param>
        /// <exception cref="ArgumentNullException"></exception>
        ...
        /// <summary>
        /// The method throws an <see cref="InvalidCastException"/> if the object is not setted type.
        /// </summary>
        /// <param name="obj">inspected object.</param>
        /// <param name="message">exception message.</param>
        ...
        /// <summary>
        /// The method throws an <see cref="InvalidCastException"/> if the object is setted type.
        /// </summary>
        /// <param name="obj">inspected object.</param>
        /// <param name="message">exception message.</param>
        /// <exception cref="InvalidCastException"></exception>
        ...
        /// <summary>
        /// The method throws an <see cref="ArgumentNullException"/> if the string is null or <see cref="Empty"/> or WhiteSpace.
        /// </summary>
        /// <param name="str">inspected string.</param>
        /// <param name="message">exception message.</param>
        /// <exception cref="ArgumentNullException"></exception>
        ...
        /// <summary>
        /// The method throws an <see cref="ArgumentNullException"/> if the string is not null or <see cref="Empty"/> or WhiteSpace.
        /// </summary>
        /// <param name="str">inspected string.</param>
        /// <param name="message">exception message.</param>
        /// <exception cref="ArgumentNullException"></exception>
